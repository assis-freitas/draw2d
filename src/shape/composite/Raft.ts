...
import WeakComposite from "./WeakComposite";
 ...
 * @since 4.7.0
 */
class Raft extends WeakComposite {
    /**
    ...
    constructor(attr, setter, getter) {
      ...
      super(extend({bgColor: "#f0f0f0", color: "#1B1B1B"}, attr), setter, getter)
    }
     ...
     **/
    setPosition (x, y, dontApplyToChildren) {
      let oldX = this.x
      let oldY = this.y
