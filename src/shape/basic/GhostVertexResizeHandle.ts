 ...
 */
class GhostVertexResizeHandle extends LineResizeHandle {
    /**
     *
     *
     */
    ...
    super({owner: owner, opacity: this.maxOpacity})
  }
  createShapeElement () {
    let shape = super()
   ...
   **/
  setAlpha (percent) {
    super(Math.min(this.maxOpacity, Math.max(0, parseFloat(percent))))
...
export default GhostVertexResizeHandle;
