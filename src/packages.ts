...
export default {
  ...
  io: {
     ...
     * */
    json: {}    /** @namespace draw2d.io.png */
    png: {}    /** @namespace draw2d.io.svg */
    svg: {}
  }
  ...
  policy: {
     ...
     **/
    connection: {}    /** @namespace draw2d.policy.line */
    line: {}    /** @namespace draw2d.policy.port */
    port: {}    /**
  ...
  shape: {
     ...
     **/
    basic: {}    /** @namespace draw2d.shape.dimetric */
    dimetric: {}    /** @namespace draw2d.shape.composite */
    composite: {}    /** @namespace draw2d.shape.arrow */
    arrow: {}    /** @namespace draw2d.shape.node */
    node: {}    /** @namespace draw2d.shape.note */
    note: {}    /** @namespace draw2d.shape.diagram */
    diagram: {}    /** @namespace draw2d.shape.flowchart */
    flowchart: {}    /** @namespace draw2d.shape.analog */
    analog: {}    /** @namespace draw2d.shape.icon */
    icon: {}    /** @namespace draw2d.shape.layout */
    layout: {}    /** @namespace draw2d.shape.pert */
    pert: {}    /** @namespace draw2d.shape.state */
    state: {}    /** @namespace draw2d.shape.widget */
    widget: {}
  }
  /**
  ...
  layout: {
     ...
     * */
    connection: {}    /** @namespace draw2d.layout.anchor */
    anchor: {}    /** @namespace draw2d.layout.mesh */
    mesh: {}    /** @namespace draw2d.layout.locator */
    locator: {}
  }
  /** @namespace draw2d.ui */
  ui: {}
