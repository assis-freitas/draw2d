...
class Connection extends PolyLine {
    private sourcePort: null;
    private targetPort: null;
    private sourceDecorator: null;
    private oldPoint: null;
    private targetDecorator: null;
    private sourceDecoratorNode: null;
    private targetDecoratorNode: null;
    private isMoving: boolean;
    private moveListener: (figure) => void;
    /**
     ...
     * @deprecated
     **/
    getStartPoint (refPoint) {
      return this.getStartPosition(refPoint)
    }
    getStartPosition (refPoint) {
     ...
     * @deprecated
     **/
    getEndPoint (refPoint) {
      return this.getEndPosition(refPoint)
    }
    getEndPosition (refPoint) {
      if (this.isMoving === false) {
        if (refPoint) {
