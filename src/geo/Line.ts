...
class Line {
     ...
     * @returns {Number}
     */
    static inverseLerp (X1: number, Y1: number, X2: number, Y2: number, px: number, py: number) {
     ...
     **/
    static pointProjection (X1: number, Y1: number, X2: number, Y2: number, px: number, py: number) {
    ...
    static distance (X1: number, Y1: number, X2: number, Y2: number, px: number, py: number) {
