 ...
 */
class SmartDraggableLocator extends Locator {
    private boundedCorners: { init: boolean; parent: number; yOffset: number; xOffset: number; dist: any; child: number };
  /**
...
export default SmartDraggableLocator;
