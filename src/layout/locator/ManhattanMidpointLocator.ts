 ...
 */
class ManhattanMidpointLocator extends ConnectionLocator {
  /**
   ...
   **/
  relocate(index: any, target: { getParent: () => any; setPosition: (arg0: number, arg1: number) => void; getWidth: () => number; getHeight: () => number }) {
...
export default ManhattanMidpointLocator;
