...
class ExplodeLayouter extends MeshLayouter {
	private MIN_MARGIN = 40;
     ...
     */
    add( canvas: { getFigures: () => any; }, figureToAdd: { getBoundingBox: () => any; })
    {
...
//        				changes[8].y =  Math.max(changes[8].y,this.MIN_MARGIN+dis);
	 ...
	 * @returns {Number}
     */
    determineOctant(r1: { x: any; y: any; w: any; h: any; }, r2: { x: any; y: any; w: any; h: any; }){
		var ox = r1.x;
		var oy = r1.y;
		var ow = r1.w;
		var oh = r1.h;
...
export default ExplodeLayouter;
