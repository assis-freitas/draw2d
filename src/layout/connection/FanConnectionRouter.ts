...
class FanConnectionRouter extends DirectRouter {
  /**
   ...
   * @param {Number} index
   */
  routeCollision(conn: { getStartPoint?: any; getEndPoint?: any; addPoint?: any; getVertices?: () => any; getRadius?: () => any; svgPathString?: string; }, index: number) {
    index = index + 1
...
export default FanConnectionRouter;
