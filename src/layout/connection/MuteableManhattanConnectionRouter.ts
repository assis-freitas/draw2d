...
class MuteableManhattanConnectionRouter extends ManhattanConnectionRouter {
   ...
   * @private
   */
  getColumnNear(connection, r, n, x) {
  ...
  processPositions(/*Ray*/ start, /*Ray*/ end, /*List*/ positions, /*boolean*/ horizontal, /*Connection*/ conn) {
  ...
  reserveColumn(connection, column) {
  ...
  findFirstFigureAtStraightLine(canvas, /*Ray*/ start, /*Ray*/ direction, /*List*/ excluding) {
    let figure = null
...
export default MuteableManhattanConnectionRouter;
