...
class InteractiveManhattanConnectionRouter extends ManhattanConnectionRouter {
  /**
  ...
  onInstall(conn: { installEditPolicy: (arg0: any) => void; _routingMetaData: { routedByUserInteraction: boolean; fromDir: number; toDir: number } }) {
  ...
  onUninstall(conn: { _routingMetaData: any }) {
...
export default InteractiveManhattanConnectionRouter;
