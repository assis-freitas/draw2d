...
class ChopboxConnectionAnchor extends ConnectionAnchor {
   ...
   */
  getLocation(reference: { x: number; y: number; }, inquiringConnection: any) {
...
export default ChopboxConnectionAnchor;
