const Configuration = {
    ...
    factory:{
    	...
    	// @since 5.2.0
    	createResizeHandle(owner, type, width, height){
    	...
    	// @since 5.3.0
        // @deprecated
    	createConnection(sourcePort, targetPort, callback, dropTarget){
            console.log("deprecated call factory.createConnection");
            debugger;
    	    return new draw2d.Connection();
    	},
        // @since 5.3.0
    	createInputPort(relatedFigure){
    	    return new draw2d.InputPort();
    	},
        // @since 5.3.0
        createOutputPort(relatedFigure){
            return new draw2d.OutputPort();
        },
        // @since 5.3.0
        createHybridPort(relatedFigure){
