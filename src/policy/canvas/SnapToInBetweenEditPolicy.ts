 ...
 * @since 5.6.4
 */
class SnapToInBetweenEditPolicy extends SnapToEditPolicy {
  SNAP_THRESHOLD = 5;
  ...
  showHorizontalGuides (causedFigure, constraint) {
  ...
  showVerticalGuides (causedFigure, constraint) {
...
export default SnapToInBetweenEditPolicy;
