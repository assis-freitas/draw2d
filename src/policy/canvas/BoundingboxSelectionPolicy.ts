 ...
 */
class BoundingboxSelectionPolicy extends SingleSelectionPolicy {
  ...
  onMouseDrag (canvas, dx, dy, dx2, dy2, shiftKey, ctrlKey) {
    ...
    try {
      super(canvas, dx, dy, dx2, dy2, shiftKey, ctrlKey)
  ...
  onMouseUp (canvas, x, y, shiftKey, ctrlKey) {
    try {
      ...
      super(canvas, x, y, shiftKey, ctrlKey)
...
export default BoundingboxSelectionPolicy;
