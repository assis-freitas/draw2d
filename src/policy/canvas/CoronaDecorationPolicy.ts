 ...
 */
class CoronaDecorationPolicy extends DecorationPolicy {
  ...
  setDiameterToBeVisible (diameter) {
  ...
  setDiameterToBeFullVisible (diameter) {
    this.diameterToBeFullVisible = diameter
    this.sumDiameter = this.diameterToBeFullVisible + this.diameterToBeVisible
  }
  getDiameterToBeFullVisible () {
...
export default CoronaDecorationPolicy;
