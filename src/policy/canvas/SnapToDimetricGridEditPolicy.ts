...
import ShowDimetricGridEditPolicy from "./ShowDimetricGridEditPolicy";
 ...
 */
class SnapToDimetricGridEditPolicy extends ShowDimetricGridEditPolicy {
  /**
...
export default SnapToDimetricGridEditPolicy;
