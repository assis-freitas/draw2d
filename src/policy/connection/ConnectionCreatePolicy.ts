...
class ConnectionCreatePolicy extends KeyboardPolicy {
    /**
     *
        ...
        switch(type){
            case 0:
                ...
                var anim = Raphael.animation(
                    {transform: "s6", opacity:0.0, "stroke-width":3 }                    500,
                    "linear",
            ...
            case 1:
                ...
                var anim1 = Raphael.animation(
                    {transform: "s6", opacity:0.0, "stroke-width":1 }                    1200,
                    "linear"
                ).repeat(Infinity);
                circle1.animate(anim1);
                var anim2 = Raphael.animation(
                    {transform: "s12", opacity:0.0, "stroke-width":4 }                    500,
                    "linear",
...
export default ConnectionCreatePolicy;
