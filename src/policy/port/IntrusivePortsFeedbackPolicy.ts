 ...
 */
class IntrusivePortsFeedbackPolicy extends PortFeedbackPolicy {
    /**
     */
    ...
    onDragStart (canvas, figure, x, y, shiftKey, ctrlKey) {
      ...
      this.tweenable.tween({
        from: {'size': start}        to: {'size': start* this.growFactor}        duration: 200,
        easing: "easeOutSine",
        step (params) {
          allPorts.each(function (i, element) {
  ...
  export default IntrusivePortsFeedbackPolicy;
