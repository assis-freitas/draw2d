 ...
 */
class ElasticStrapFeedbackPolicy extends PortFeedbackPolicy {
  ...
  onHoverEnter (canvas, draggedFigure, hoverFiger) {
    this.connectionLine.setGlow(true)
    hoverFiger.setGlow(true)
  }
  onHoverLeave (canvas, draggedFigure, hoverFiger) {
...
export default ElasticStrapFeedbackPolicy;
